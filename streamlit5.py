        ...
        if arch_column:
            ...
            if mean == 'ARX':
                ...
                if len(exog_columns) > 0:
                    ...
                    # Create shifted exogenous DataFrame with unique names
                    ...
                    for col in exog_columns:
                        ...
                        # Create lagged (backward) shifted columns
                        for lag in range(1, lags + 1):
                            lagged_exog[f'{col}_lagged_{lag-1}'] = df[col].shift(lag)

                        # Optionally, include current values if checkbox is ticked
                        
                            lagged_exog[col] = df[col]

                    # Join shifted exogenous variables to the temporary DataFrame
