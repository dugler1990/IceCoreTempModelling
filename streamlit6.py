...
# Define session state for selected tab
if 'selected_tab' not in st.session_state:
    st.session_state.selected_tab = 'Data Input'

# Function to handle sidebar controls
def display_sidebar_for_tab(tab_name):
    if tab_name == 'Plots':
        ...
        st.session_state.plot_params = plot_params
        ...
        st.session_state.regression_params = {'x_axis': x_axis, 'y_axis': y_axis, 'transformations': transformation_options}
